...
- [ ] **Step 1: 写主库单例** `data/db/DbProvider.kt`
...
- [ ] **Step 2: 写数据读取器** `ui/widget/WidgetDataReader.kt`
...
- [ ] **Step 3: DataModule 委托单例** `data/di/DataModule.kt`
...
- [ ] **Step 4: 改写「下一节课」组件** `ui/widget/NextClassWidget.kt`（替换 Task 1 冒烟版）
