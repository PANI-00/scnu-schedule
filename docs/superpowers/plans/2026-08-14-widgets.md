...
- [ ] **Step 1: 写 provider 配置** `res/xml/today_widget.xml`
...
- [ ] **Step 3: 写组件** `ui/widget/TodayWidget.kt`
...
- [ ] **Step 4: 写 receiver** `ui/widget/TodayWidgetReceiver.kt`
...
- [ ] **Step 1: 写 provider 配置** `res/xml/week_widget.xml`
...
- [ ] **Step 3: 写组件** `ui/widget/WeekWidget.kt`
...
- [ ] **Step 4: 写 receiver** `ui/widget/WeekWidgetReceiver.kt`
...
- [ ] **Step 1: 写刷新通知器** `ui/widget/WidgetUpdateNotifier.kt`
...
- [ ] **Step 2: 写刷新接收器** `ui/widget/WidgetRefreshReceiver.kt`
...
- [ ] **Step 4: 改 `CourseRepositoryImpl`**（注入 Context，写后发广播）
...
- [ ] **Step 5: 改 `TimeTableRepositoryImpl`**
...
- [ ] **Step 6: 改 `SettingsRepositoryImpl`**
