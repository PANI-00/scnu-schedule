...
- [ ] **Step 1: 版本目录加 glance** `gradle/libs.versions.toml`
...
- [ ] **Step 2: app 依赖加 glance** `app/build.gradle.kts`
...
- [ ] **Step 3: 加组件名字符串** `app/src/main/res/values/strings.xml`
...
- [ ] **Step 4: 写初始加载占位布局** `app/src/main/res/layout/widget_loading.xml`
...
- [ ] **Step 5: 写「下一节课」provider 配置** `app/src/main/res/xml/next_class_widget.xml`
...
- [ ] **Step 6: Manifest 注册 receiver** `app/src/main/AndroidManifest.xml`
...
- [ ] **Step 7: 写 hello 冒烟组件** `app/src/main/java/com/scnu/schedule/ui/widget/NextClassWidget.kt`
...
- [ ] **Step 8: 写 receiver** `app/src/main/java/com/scnu/schedule/ui/widget/NextClassWidgetReceiver.kt`
...
- [ ] **Step 1: 写失败测试** `WidgetFormatterTest.kt`
...
- [ ] **Step 4: 写纯逻辑** `WidgetFormatter.kt`
